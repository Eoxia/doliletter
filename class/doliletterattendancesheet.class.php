...
/**
 * \file    class/doliletterattendancesheet.class.php
 * \ingroup doliletter
 * \brief   This file is a CRUD class file for SaturneAttendanceSheet (Create/Read/Update/Delete).
 */
...
/**
 * Class for SaturneAttendanceSheet.
 */
class DoliletterAttendanceSheet extends SaturneObject
{
    /**
	 ...
	 */
	public $element = 'doliletter_attendance_sheet';

	/**
	 * @var string Name of table without prefix where object is stored. This is also the key used for extrafields management.
	 */
	public $table_element = 'doliletter_attendance_sheet';
