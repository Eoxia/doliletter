...
/**
 * \file        class/dolilettersignature.class.php
 * \ingroup     doliletter
 * \brief       This file is a CRUD class file for DoliletterSignature (Create/Read/Update/Delete)
 */
...
/**
 * Class for DoliletterSignature
 */
class DoliletterSignature extends CommonObject
{
	/**
	 ...
	 */
	public $element = 'dolilettersignature';

	/**
	 * @var string Name of table without prefix where object is stored. This is also the key used for extrafields management.
	 */
	public $table_element = 'doliletter_dolilettersignature';
	...
	/**
	 * @var string String with name of icon for dolilettersignature. Must be the part after the 'object_' into object_doliletter.png
	 */
