...
if ($isPreventionPlan) {
    ...
    // Recapitulatif de fin de page : l'equipement a prevoir pour l'intervention, une seule fois
    // chacun, un meme moyen de prevention revenant sur plusieurs risques
